        ...
        function button_listener(e){
            ...
            switch(button_word){
                ...
                case 'quit':
                    ...
                    this.parentNode.querySelector('.button[data-buttonword="x"]').innerHTML = 'start';
                    this.parentNode.querySelector('.button[data-buttonword="x"]').setAttribute('data-buttonword', 'start');
                    break;
                case 'device':
